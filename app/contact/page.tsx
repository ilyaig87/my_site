        ...
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-10">
            <a
              ...
              className="group lg-surface lg-shallow squircle-md p-5 flex flex-col items-center text-center transition-transform hover:scale-[1.03]"
            >
              <div
              ...
              <p className="relative z-10 text-sm font-bold text-[var(--text-strong)] mb-1">טלפון</p>
              <p className="relative z-10 text-xs text-[var(--text-muted)]" dir="ltr">
                {phoneDisplay}
              </p>
            </a>
            ...
            >
              ...
              <p className="relative z-10 text-sm font-bold text-[var(--text-strong)] mb-1">אימייל</p>
              <p className="relative z-10 text-xs text-[var(--text-muted)] truncate max-w-full" dir="ltr">
