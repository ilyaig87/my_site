      ...
      <section className="relative">
        <Container>
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-3xl mx-auto mb-10">
            ...
            >
              <div
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center mb-2 sm:mb-3 relative z-10"
                style={{ background: 'radial-gradient(circle at 30% 30%, var(--primary-bright), var(--primary))' }}
              >
                <svg className="w-5 h-5 text-[var(--on-accent)]" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
              </div>
              <p className="relative z-10 text-xs sm:text-sm font-bold text-[var(--text-strong)] mb-1">טלפון</p>
              <p className="relative z-10 text-[10px] sm:text-xs text-[var(--text-muted)] leading-tight break-all" dir="ltr">
                {phoneDisplay}
              </p>
            </a>
            ...
            >
              ...
              <p className="relative z-10 text-xs sm:text-sm font-bold text-[var(--text-strong)] mb-1">אימייל</p>
              <p className="relative z-10 text-[10px] sm:text-xs text-[var(--text-muted)] leading-tight break-all max-w-full" dir="ltr">
