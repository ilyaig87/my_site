...
export const FAQ_ITEMS: FAQItem[] = [
  { category: 'general', question: 'כמה זמן לוקח לבנות אתר?', answer: 'תלוי בחבילה: Starter (דף נחיתה) - עד 5 ימי עסקים ולעיתים גם פחות, תלוי במורכבות. Business - 1-2 שבועות. Premium - 2-4 שבועות לפי ההיקף. הזמנים תלויים גם בזמינות התכנים והתמונות מצדכם.' },
