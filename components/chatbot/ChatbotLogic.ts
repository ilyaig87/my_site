...
📄 **Starter** - 2,500 ₪ (חד-פעמי)
דף נחיתה אחד ממוקד המרה — עד 5 סקשנים, הכל בעמוד אחד.

🏢 **Business** — הצעת מחיר מותאמת
אתר עסקי מלא — מספר עמודים עם ניווט, גלריה ו-SEO מלא.

🚀 **Premium** — הצעת מחיר מותאמת
אתר מתקדם — בלוג/CMS, אנימציות ואינטגרציות, לפי הצרכים שלכם.

🤖 **AI ואוטומציה** — הצעת מחיר מותאמת
צ'אטבוטים חכמים ואוטומציות לעסק.

למה "מותאמת"? כי כל עסק שונה — ספרו לנו מה אתם צריכים ותקבלו הצעה מדויקת תוך 24 שעות, בלי הפתעות ובלי תשלומים חודשיים נסתרים. רוצים שאפרט מה כלול בכל חבילה?`,
    category: 'pricing'
  },
...
מעוניינים להתחיל?`,
  ...
  // Business website
  {
    ...
    response: `🏢 **Business** — הצעת מחיר מותאמת

אתר עסקי מלא עם נוכחות מקצועית. המחיר נקבע לפי מספר העמודים והצרכים — ספרו לנו ותקבלו הצעה מדויקת תוך 24 שעות.

✅ כולל:
• כל מה שב-Starter, ובנוסף:
• מספר עמודים עם ניווט מלא (בית, אודות, שירותים, גלריה, צור קשר)
...
• פורטפוליו עסקי מלא עם כמה עמודים וגלריה מתקדמת? **Business** — בהצעת מחיר מותאמת.
• פורטפוליו מתקדם עם בלוג, אנימציות מרשימות ואינטגרציות? **Premium** — בהצעת מחיר מותאמת.

כל החבילות כוללות עיצוב מותאם אישית, אופטימיזציה לתמונות, חיבור לדומיין שלכם וליווי צמוד.
...
איזו רמה מתאימה לכם?`,
  ...
  // E-commerce
  {
    ...
    response: `🛍️ **חנות / קטלוג מוצרים** — חבילת Premium (בהצעת מחיר מותאמת)
...
**זמן ביצוע:** דף נחיתה — עד 5 ימי עסקים; אתרים מלאים — 1-4 שבועות לפי היקף
...
אנחנו מתמחים בעזרה לעסקים קטנים ובינוניים להשיק נוכחות דיגיטלית מושלמת במהירות ובמחיר הוגן.`,
  ...
  // Technologies
  {
    ...
    response: `💻 **בוחרים טכנולוגיה לפי הצורך שלכם:**

⚡ **פיתוח בהתאמה אישית** — Next.js, React, TypeScript, Node.js (אתרים מהירים במיוחד)
📝 **ניהול תוכן עצמאי** — WordPress, Elementor, Wix Studio (מעדכנים לבד, בלי מתכנת)
🛍️ **חנויות אונליין** — Shopify, WooCommerce
🤖 **אוטומציות ו-AI** — צ'אטבוטים חכמים, WhatsApp API, CRM, Make

לא מתחילים מהכלי — מתחילים ממה שהעסק שלכם צריך, ובוחרים יחד את הפתרון הנכון.`,
    category: 'tech'
  },
...
📄 **Starter (דף נחיתה):** עד 5 ימי עסקים, לעיתים פחות
🏢 **Business:** 1-2 שבועות
...
חשוב לדעת: דומיין ואחסון **אינם כלולים** במחיר חבילת הבנייה.

💳 **דומיין** — רכישה וניהול על שמכם: 150 ₪ לשנה כתוספת (יש לכם כבר דומיין? נחבר אותו בחינם).
☁️ **אחסון** — משולם ישירות לספק האחסון לפי המסלול שתבחרו; לאתר עסקי קטן מדובר לרוב בעשרות שקלים בודדות בחודש. אנחנו נמליץ, נקים ונחבר הכל עבורכם.

הכל שקוף ומסוכם מראש — בלי הפתעות.`,
    category: 'technical'
  },
