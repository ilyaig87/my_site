...
📄 **דף בודד / דף נחיתה** - החל מ-1,500 ₪
דף יחיד ממוקד - לקמפיין, מוצר או שירות

🏢 **אתר תדמית (פופולרי)** - החל מ-3,000 ₪
אתר תדמית מלא עד 4 דפים - מושלם לעסקים קטנים ובינוניים

🚀 **אתר מורחב** - החל מ-5,000 ₪
5+ דפים, עיצוב מותאם, אינטגרציות מתקדמות ופאנל ניהול

כל המחירים חד-פעמיים, ללא תשלומים חודשיים. המחיר הסופי לפי הצורך - נשמח לתת הצעת מחיר מותאמת אישית. רוצה לשמוע עוד על חבילה מסוימת?`,
    category: 'pricing'
  },
  ...
  // Landing page
  {
    ...
    response: `📄 **דף בודד / דף נחיתה** - החל מ-1,500 ₪

דף יחיד ממוקד - לקמפיין, מוצר או שירות. מושלם להמרות גבוהות.
...
מעוניין להתחיל?`,
  ...
  // Business website
  {
    ...
    response: `🏢 **אתר תדמית (החבילה הכי פופולרית)** - החל מ-3,000 ₪
...
לפורטפוליו עם 5+ דפים וגלריות מתקדמות במיוחד - חבילת "אתר מורחב" החל מ-5,000 ₪.
...
מוכן להציג את העבודות שלך באופן מקצועי?`,
  ...
  // E-commerce
  {
    ...
    response: `🛍️ **מיני חנות/קטלוג מוצרים** - החל מ-5,000 ₪ (חבילת אתר מורחב)
