...
export default function FloatingWhatsApp() {
  ...
  return (
    ...
    >
      ...
      <svg
        className="relative z-10 w-7 h-7 sm:w-8 sm:h-8 text-white drop-shadow"
        fill="currentColor"
        viewBox="0 0 24 24"
        aria-hidden="true"
      >
      ...
      <span className="hidden md:flex absolute right-full mr-3 top-1/2 -translate-y-1/2 lg-surface lg-shallow squircle-sm px-3 py-1.5 text-xs font-bold text-[var(--text-strong)] whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity">
        <span className="relative z-10">שלחו הודעה</span>
      </span>
    </a>
  );
}
