...
export default function FAQSection() {
  ...
  const faqs: FAQItem[] = [
    ...
    { category: 'pricing', question: 'כמה עולה אתר?', answer: 'שלוש חבילות: Starter — דף נחיתה אחד ממוקד המרה — 2,500 ₪. Business — אתר עסקי מלא עד 5 עמודים עם גלריה ו-SEO מלא — 3,500 ₪. Premium — אתר מתקדם עם בלוג/CMS, אנימציות ואינטגרציות — החל מ-5,000 ₪. Premium הוא "החל מ-" כי פיצ\'רים מתקדמים (חנות ותשלומים, מערכת הזמנות, אזור משתמשים, רב-לשוני) מתומחרים לפי הצורך. המחירים חד-פעמיים, ללא הפתעות.' },
