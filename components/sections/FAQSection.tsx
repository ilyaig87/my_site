...
export default function FAQSection() {
  ...
  const faqs: FAQItem[] = [
    { category: 'general', question: 'כמה זמן לוקח לבנות אתר?', answer: 'תלוי בהיקף: דף נחיתה (עמוד אחד) - 5-7 ימי עבודה. אתר רב-עמודי - לפי מספר הדפים, בדרך כלל 2-3 שבועות. הזמנים תלויים גם בזמינות התכנים והתמונות מצדכם.' },
    ...
    { category: 'pricing', question: 'כמה עולה אתר?', answer: 'דף נחיתה — עמוד אחד ממוקד המרה, עד 5 רכיבים, הכל בעמוד אחד וללא דפים נוספים — 2,500 ₪. צריכים אתר רב-עמודי? כל דף נוסף הוא תוספת לפי הצורך, והמחיר נבנה אישית לפי מספר הדפים והרכיבים. המחירים חד-פעמיים, ללא הפתעות.' },
    { category: 'pricing', question: 'מה כולל המחיר?', answer: 'המחיר כולל: עיצוב מותאם, פיתוח ב-Next.js / React, התאמה רספונסיבית מלאה, אופטימיזציה ל-SEO, העלאה לדומיין שלכם, אבטחת SSL וליווי צמוד עם תיקונים אחרי ההשקה — עד שאתם מרוצים. דומיין ואחסון שנתי - 300 ₪ כתוספת.' },
    ...
    { category: 'technical', question: 'מה לגבי SEO וקידום אורגני?', answer: 'בדף נחיתה נכלל SEO בסיסי + Open Graph. באתר רב-עמודי אפשר להרחיב ל-SEO מלא, Schema.org, Google Analytics, Pixel ו-Mailchimp/CRM — לפי הצורך, וכן אופטימיזציה מקיפה של Core Web Vitals.' },
    ...
    { category: 'support', question: 'מה קורה אם משהו נשבר באתר אחרי ההשקה?', answer: 'אנחנו מלווים אתכם צמוד גם אחרי ההשקה ומתקנים כל תקלה — עד שאתם מרוצים, בלי שעון שרץ. להמשך טיפול שוטף אפשר תחזוקה חודשית (החל מ-150 ₪/חודש).' },
    { category: 'support', question: 'מה ההבדל בין תיקוני באגים לשינויים?', answer: 'תיקון באג = משהו לא פועל כפי שסוכם. שינוי = הוספה או החלפה של תוכן. התיקונים כלולים בליווי הצמוד שלאחר ההשקה — עד שאתם מרוצים; שינויים מתומחרים בנפרד.' },
