...
export default function FAQSection() {
  ...
  const faqs: FAQItem[] = [
    ...
    { category: 'support', question: 'מה קורה אם משהו נשבר באתר אחרי ההשקה?', answer: 'בכל אתר כלול חודש של תיקוני באגים (ניתן להרחיב באתר רב-עמודי). לאחר מכן ניתן להמשיך לתחזוקה חודשית (החל מ-150 ₪/חודש).' },
