  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: 'תלוי בחבילה: דף בודד (1,500 ₪) - 5-7 ימי עבודה, אתר תדמית (3,000 ₪) - 7-14 ימי עבודה, אתר מורחב (5,000 ₪) - 2-3 שבועות. הזמנים תלויים בזמינות התכנים מצדכם.'
    },
    {
      category: 'general',
      question: 'האם אני יכול לערוך את האתר בעצמי אחרי שהוא מוכן?',
      answer: 'באתר המורחב כלול פאנל ניהול תוכן בסיסי שמאפשר לערוך טקסטים ותמונות. בחבילות הקטנות יותר אפשר להוסיף פאנל ניהול בתוספת תשלום, או שנעדכן עבורכם בקלות.'
    },
    {
      category: 'pricing',
      question: 'כמה עולה אתר?',
      answer: 'יש 3 חבילות עיקריות: דף בודד / דף נחיתה - 1,500 ₪, אתר תדמית עד 4 דפים (הכי פופולרי) - 3,000 ₪, אתר מורחב 5+ דפים עם DB ופאנל ניהול - 5,000 ₪. כל המחירים חד-פעמיים.'
    },
    {
      category: 'pricing',
    ...
    },
    {
      ...
      answer: 'לא! המחיר חד פעמי. דומיין ואחסון בתוספת של 300 ₪/שנה (אם אתם רוצים שנטפל בזה). אין עלויות נסתרות או התחייבות חודשית. תחזוקה חודשית היא אופציה נפרדת (200 ₪/חודש) לאתר מורחב.'
    },
    {
      category: 'pricing',
    ...
    },
    {
      ...
      answer: 'בהחלט! כל אתר שאנחנו בונים הוא רספונסיבי לחלוטין - נראה מושלם במחשב, טאבלט וסלולר. רוב הגולשים היום נכנסים מסלולר, אז זה הבסיס של כל אתר.'
    },
    {
      category: 'technical',
    ...
    },
    {
      ...
      answer: 'בחבילת דף בודד יש SEO בסיסי. באתר תדמית SEO מלא + Google Analytics. באתר מורחב יש SEO מתקדם + Google Analytics + Pixel + אינטגרציה עם CRM ומיילים. קידום ממומן הוא שירות נפרד.'
    },
    {
      category: 'technical',
      question: 'איך מטפלים בדומיין ואחסון?',
      answer: 'אפשר להעלות לדומיין שלכם הקיים ללא תוספת. אם אין לכם, נטפל ברכישה והקמה ב-300 ₪/שנה (כולל אחסון + SSL). תקבלו גישה מלאה - הדומיין שלכם, לא שלנו.'
    },
    {
      category: 'support',
      question: 'מה קורה אם משהו נשבר באתר?',
      answer: 'בכל החבילות כלול חודש של תיקוני באגים (חודשיים בחבילה המורחבת). אחרי זה אפשר תחזוקה חודשית (200 ₪/חודש לאתר מורחב) או לקרוא לנו בתשלום לפי שעה. אנחנו זמינים ב-WhatsApp.'
    },
    {
      category: 'support',
    ...
    },
    {
      ...
      answer: 'אנחנו עוזרים בעריכה ושיפור של תוכן קיים בחינם. כתיבת תוכן שיווקי מלא (copywriting) היא שירות נפרד בתוספת תשלום. תמונות מבנקי תמונות חינמיים נוכל לדאוג, צילום מקצועי על חשבונכם.'
    },
    {
      category: 'general',
