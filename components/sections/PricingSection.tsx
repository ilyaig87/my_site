  ...
  const packages = [
    {
      ...
      description: 'עמוד אחד ממוקד המרה — הכל בעמוד אחד, ללא דפים נוספים',
      priceDisplay: '2,500 ₪',
      features: [
        'עמוד אחד (Single Page) — ללא ראוטינג לדפים נוספים',
        'עד 5 רכיבים/סקשנים בעמוד',
    ...
    {
      name: 'אתר רב-עמודי',
      tagline: 'כל דף נוסף לפי הבקשה שלכם',
      description: 'מעבר לדף נחיתה? כל דף נוסף הוא תוספת — בהצעת מחיר אישית',
      priceDisplay: 'הצעת מחיר אישית',
      features: [
        'מבוסס על דף הנחיתה (2,500 ₪) כבסיס',
        'כל דף נוסף מעבר לעמוד הראשון = תוספת לפי הצורך',
    ...
    <section className="py-6 bg-gradient-to-b from-gray-50 to-white">
      <Container>
        <div className="max-w-6xl mx-auto">
          ...
          {/* Packages Grid */}
          <div className="grid sm:grid-cols-2 gap-3 items-stretch max-w-3xl mx-auto">
